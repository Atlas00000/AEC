...
| [phase1-analysis.md](./phase1-analysis.md) | Full-range Phase 1 conclusions |
| [phase2-preset-spec.md](./phase2-preset-spec.md) | Phase 2 filter specs + T05–T09 results |
| [phase3-optimization.md](./phase3-optimization.md) | Phase 3–9 rationale |
| [addtions.md](./addtions.md) | Quality-filter ideas (IDs **3.11–3.16**, **5.5**, **6.7–6.8** in edge-discovery) |

Code lives in the parent folder (`AEC.mq5`, `Config/`, `Core/`, etc.).
